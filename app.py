...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to My Stock Dash App.<br> Here U will Get All Latest Updates on Stock Market Prices., className="start"),
                html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey Pal! Please Enter a legitimate Stock Code to Get Details.", "https://assets.cmcmarkets.com/images/Forex-vs-stocks_extra.webp", "", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
